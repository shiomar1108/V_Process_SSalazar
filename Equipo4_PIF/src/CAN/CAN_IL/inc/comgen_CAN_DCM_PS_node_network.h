...
#define kCAN_DCM_PS_msgTimeout_BCM_5    (2500u)
#define kCAN_DCM_PS_msgTimeout_BCM_2    (2500u)
#define kCAN_DCM_PS_msgTimeout_DCU_1    (1000u)
...
#define kCAN_DCM_PS_avlbl_buffer_idx_DCU_1    (2u)
...
#define kCAN_DCM_PS_avlbl_buffer_len		(4u)

/* RX message(s) indexes - sorted by ID -*/
typedef enum{
	kCAN_DCM_PS_rxMsgIdx_BCM_5=0,
...
#define p_CAN_DCM_PS_get_msg_BCM_2(data_struct)		CALVOS_CRITICAL_ENTER(); \
															memcpy(data_struct->all, \
															can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].data, \
															can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_BCM_2].fields.len); \
															CALVOS_CRITICAL_EXIT();
...
#define p_CAN_DCM_PS_get_msg_DCU_1(data_struct)		CALVOS_CRITICAL_ENTER(); \
															memcpy(data_struct->all, \
															can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].data, \
															can_DCM_PS_rxMsgStaticData[kCAN_DCM_PS_rxMsgIdx_DCU_1].fields.len); \
															CALVOS_CRITICAL_EXIT();
...
#define CAN_DCM_PS_get_avlbl_DCU_1_WindowPos()                   (can_DCM_PS_avlbl_buffer[2] & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_WindowPos()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xfeu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_LockingReq()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x01u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_LockingReq()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xfdu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_WindowOp()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x02u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_WindowOp()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xfbu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_RearWindowLock()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x03u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_RearWindowLock()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xf7u)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_DoorLockSts()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x04u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_DoorLockSts()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xefu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_WdwCtrl_RR()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x05u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_WdwCtrl_RR()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xdfu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_WdwCtrl_RL()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x06u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_WdwCtrl_RL()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0xbfu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_WdwCtrl_Pas()                   ((can_DCM_PS_avlbl_buffer[2] >> 0x07u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_WdwCtrl_Pas()                   (can_DCM_PS_avlbl_buffer[2] = can_DCM_PS_avlbl_buffer[2] & 0x7fu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_MC()                   (can_DCM_PS_avlbl_buffer[3] & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_MC()                   (can_DCM_PS_avlbl_buffer[3] = can_DCM_PS_avlbl_buffer[3] & 0xfeu)
...
#define CAN_DCM_PS_get_avlbl_DCU_1_CRC()                   ((can_DCM_PS_avlbl_buffer[3] >> 0x01u) & 0x01u)
#define CAN_DCM_PS_clr_avlbl_DCU_1_CRC()                   (can_DCM_PS_avlbl_buffer[3] = can_DCM_PS_avlbl_buffer[3] & 0xfdu)
...
#define p_CAN_DCM_PS_update_msg_DCU_2(data_struct)		CALVOS_CRITICAL_ENTER(); \
															memcpy(can_DCM_PS_txMsgStaticData[kCAN_DCM_PS_txMsgIdx_DCU_2].data, \
															data_struct->all, \
															can_DCM_PS_txMsgStaticData[kCAN_DCM_PS_txMsgIdx_DCU_2].fields.len); \
															CALVOS_CRITICAL_EXIT();
