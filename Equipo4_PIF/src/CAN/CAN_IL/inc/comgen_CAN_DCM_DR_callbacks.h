...
extern void can_DCM_DR_DCU_3_rx_callback(void);
extern void can_DCM_DR_DCU_4_rx_callback(void);
...
extern void can_DCM_DR_DCU_3_timeout_callback(void);
extern void can_DCM_DR_DCU_4_timeout_callback(void);
