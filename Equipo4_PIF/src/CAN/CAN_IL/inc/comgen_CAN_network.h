...
typedef union{
	struct __attribute__((packed)){
		...
		uint32_t VehSpeed_H : 8;
		uint32_t VehSpeed_L : 8;
...
/* Macros added by user, to show the byte location of the messages. */

#define BYTE_POS_DCU_1_WindowPos		0U
#define BYTE_POS_DCU_1_LockingReq		1U
#define BYTE_POS_DCU_1_WindowOp			2U
#define BYTE_POS_DCU_1_RearWindowLock 	3U
#define BYTE_POS_DCU_1_DoorLockSts 		4U
#define BYTE_POS_DCU_1_WdwCtrl_RR 		5U
#define BYTE_POS_DCU_1_WdwCtrl_RL		5U
#define BYTE_POS_DCU_1_WdwCtrl_Pas		5U
#define BYTE_POS_DCU_1_reserved_0		5U
#define BYTE_POS_DCU_1_MC				6U
#define BYTE_POS_DCU_1_CRC				7U
...
typedef union{
	struct __attribute__((packed)){
		uint32_t DCU_2_WindowPos : 8;
		uint32_t DCU_2_LockingReq : 8;
		uint32_t DCU_2_WindowOp : 8;
		uint32_t reserved_0 : 8;
//		uint32_t reserved_1 : 2;
		uint32_t DCU_2_DoorLockSts : 8;
		uint32_t reserved_1 : 8;
		uint32_t DCU_2_MC : 8;
		uint32_t DCU_2_CRC : 8;
	} s;
	uint8_t all[kCAN_msgLen_DCU_2];
}S_DCU_2;

#define BYTE_POS_DCU_2_WindowPos		0
#define BYTE_POS_DCU_2_LockingReq		1
#define BYTE_POS_DCU_2_WindowOp			2
#define BYTE_POS_DCU_2_reserved_0		3
#define BYTE_POS_DCU_2_DoorLockSts		4
#define BYTE_POS_DCU_2_reserved_1		5
#define BYTE_POS_DCU_2_MC				6
#define BYTE_POS_DCU_2_CRC				7
...
#define CAN_extract_DCU_2_DoorLockSts(msg_buffer)            ((msg_buffer[4]) >> 2u)
...
#define CAN_write_DCU_2_DoorLockSts(msg_buffer,data)         *(uint16_t*)&msg_buffer[4] = (*(uint16_t*)&msg_buffer[4] & 0xfc03u) | ((data << 2u) & 0x3fcu);
...
typedef union{
	struct __attribute__((packed)){
		uint32_t DCU_3_WindowPos : 8;
		uint32_t reserved_0 : 8;
		uint32_t DCU_3_WindowOp : 8;
		uint32_t reserved_1 : 8;
//		uint32_t reserved_2 : 2;
		uint32_t DCU_3_DoorLockSts : 8;
		uint32_t reserved_2 : 8;
		uint32_t DCU_3_MC : 8;
		uint32_t DCU_3_CRC : 8;
	} s;
	uint8_t all[kCAN_msgLen_DCU_3];
}S_DCU_3;

#define BYTE_POS_DCU_3_WindowPos		0
#define BYTE_POS_DCU_3_reserved_0		1
#define BYTE_POS_DCU_3_WindowOp			2
#define BYTE_POS_DCU_3_reserved_1		3
#define BYTE_POS_DCU_3_DoorLockSts		4
#define BYTE_POS_DCU_3_reserved_2		5
#define BYTE_POS_DCU_3_MC				6
#define BYTE_POS_DCU_3_CRC				7
...
#define CAN_extract_DCU_3_DoorLockSts(msg_buffer)            ((msg_buffer[4]) >> 2u)
...
#define CAN_write_DCU_3_DoorLockSts(msg_buffer,data)         *(uint16_t*)&msg_buffer[4] = (*(uint16_t*)&msg_buffer[4] & 0xfc03u) | ((data << 2u) & 0x3fcu);
...
typedef union{
	struct __attribute__((packed)){
		uint32_t DCU_4_WindowPos : 8;
		uint32_t reserved_0 : 8;
		uint32_t DCU_4_WindowOp : 8;
		uint32_t reserved_1 : 8;
//		uint32_t reserved_2 : 2;
		uint32_t DCU_4_DoorLockSts : 8;
		uint32_t reserved_2 : 8;
		uint32_t DCU_4_MC : 8;
		uint32_t DCU_4_CRC : 8;
	} s;
	uint8_t all[kCAN_msgLen_DCU_4];
}S_DCU_4;

#define BYTE_POS_DCU_4_WindowPos		0
#define BYTE_POS_DCU_4_reserved_0		1
#define BYTE_POS_DCU_4_WindowOp			2
#define BYTE_POS_DCU_4_reserved_1		3
#define BYTE_POS_DCU_4_DoorLockSts		4
#define BYTE_POS_DCU_4_reserved_2		5
#define BYTE_POS_DCU_4_MC				6
#define BYTE_POS_DCU_4_CRC				7
...
#define CAN_extract_DCU_4_DoorLockSts(msg_buffer)            ((msg_buffer[4]) >> 2u)
...
#define CAN_write_DCU_4_DoorLockSts(msg_buffer,data)         *(uint16_t*)&msg_buffer[4] = (*(uint16_t*)&msg_buffer[4] & 0xfc03u) | ((data << 2u) & 0x3fcu);
