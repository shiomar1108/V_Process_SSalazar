...
/* ===========================================================================*/
/** Callback for DCU_3 reception.
 *
 * Invoked within ISR context whenever DCU_3 is received by node DCM_DR
 *  of network B.
 * ===========================================================================*/
void can_DCM_DR_DCU_3_rx_callback(void){
	/* User code goes here... */
}

/* ===========================================================================*/
/** Callback for DCU_4 reception.
 *
 * Invoked within ISR context whenever DCU_4 is received by node DCM_DR
 *  of network B.
 * ===========================================================================*/
void can_DCM_DR_DCU_4_rx_callback(void){
	/* User code goes here... */
}
...
/* ===========================================================================*/
/** Callback for DCU_3 timeout notification.
 *
 * Invoked when DCU_3 times out as per suscriber node DCM_DR
 * of network B.
 * ===========================================================================*/
void can_DCM_DR_DCU_3_timeout_callback(void){
	/* User code goes here... */
}
/* ===========================================================================*/
/** Callback for DCU_4 timeout notification.
 *
 * Invoked when DCU_4 times out as per suscriber node DCM_DR
 * of network B.
 * ===========================================================================*/
void can_DCM_DR_DCU_4_timeout_callback(void){
	/* User code goes here... */
}
...
void can_DCM_DR_DCU_1_tx_callback(void){
	...
	l_MessageCounter = CAN_DCM_DR_get_direct_DCU_1_MC() + 1;
	if(l_MessageCounter > 0xFF){
		CAN_DCM_DR_update_direct_DCU_1_MC(0x00)
	}else{
		CAN_DCM_DR_update_direct_DCU_1_MC(l_MessageCounter)
	}
}
