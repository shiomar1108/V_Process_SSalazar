...
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_3_WindowPos      (0u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_3_WindowOp       (1u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_3_DoorLockSts    (2u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_3_MC             (3u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_3_CRC            (4u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_4_WindowPos      (0u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_4_WindowOp       (1u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_4_DoorLockSts    (2u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_4_MC             (3u)
#define kCAN_DCM_DR_sig_avlbl_idx_DCU_4_CRC            (4u)
...
const CANrxMsgStaticData can_DCM_DR_rxMsgStaticData[kCAN_DCM_DR_nOfRxMsgs] = {\
		{kCAN_msgId_BCM_5,	kCAN_DCM_DR_msgTimeout_BCM_5,	&can_DCM_DR_BCM_5_rx_callback,	&can_DCM_DR_BCM_5_timeout_callback,	 \
				&can_DCM_DR_RxDataBuffer[0],	&can_DCM_DR_avlbl_buffer[kCAN_DCM_DR_avlbl_buffer_idx_BCM_5],	kCAN_DCM_DR_avlbl_slot_len_BCM_5,	 \
		...
		{kCAN_msgId_DCU_2,	kCAN_DCM_DR_msgTimeout_DCU_2,	&can_DCM_DR_DCU_2_rx_callback,	&can_DCM_DR_DCU_2_timeout_callback,	 \
				&can_DCM_DR_RxDataBuffer[8],	&can_DCM_DR_avlbl_buffer[kCAN_DCM_DR_avlbl_buffer_idx_DCU_2],	kCAN_DCM_DR_avlbl_slot_len_DCU_2,	 \
				&can_DCM_DR_rxMsgDynamicData[1],	{8u,	kFalse},	&can_DCM_DR_rxMsgStaticData[0],	&can_DCM_DR_rxMsgStaticData[2]}, \
		{kCAN_msgId_DCU_3,	kCAN_DCM_DR_msgTimeout_DCU_3,	&can_DCM_DR_DCU_3_rx_callback,	&can_DCM_DR_DCU_3_timeout_callback,	 \
				&can_DCM_DR_RxDataBuffer[16],	&can_DCM_DR_avlbl_buffer[kCAN_DCM_DR_avlbl_buffer_idx_DCU_3],	kCAN_DCM_DR_avlbl_slot_len_DCU_3,	 \
				&can_DCM_DR_rxMsgDynamicData[2],	{8u,	kFalse},	NULL,	NULL}, \
		{kCAN_msgId_DCU_4,	kCAN_DCM_DR_msgTimeout_DCU_4,	&can_DCM_DR_DCU_4_rx_callback,	&can_DCM_DR_DCU_4_timeout_callback,	 \
				&can_DCM_DR_RxDataBuffer[24],	&can_DCM_DR_avlbl_buffer[kCAN_DCM_DR_avlbl_buffer_idx_DCU_4],	kCAN_DCM_DR_avlbl_slot_len_DCU_4,	 \
...
const CANtxMsgStaticData can_DCM_DR_txMsgStaticData[kCAN_DCM_DR_nOfTxMsgs] = {\
									{kCAN_msgId_DCU_1,	 \
									kCAN_msgTxPeriod_DCU_1,	 \
									&can_DCM_DR_DCU_1_tx_callback,	 \
									&can_DCM_DR_TxDataBuffer[0],	 \
									&can_DCM_DR_txMsgDynamicData[0], \
									{8u,	kFalse,	kCAN_msgTxType_DCU_1}}};
...
void can_DCM_DR_signalsInit(void){
	...
	//Buffer was previously cleaned, just innitialize values diferent from ZERO
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_WindowPos] 	= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_LockingReq] 	= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_WindowOp] 	= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_RearWindowLock]= 0;
	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_DoorLockSts] = 2;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_WdwCtrl_RR]	= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_reserved_0] 	= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_MC] 			= 0;
//	can_DCM_DR_TxDataBuffer[BYTE_POS_DCU_1_CRC] 		= 0;
...
void can_DCM_DR_coreInit(void){
	...
	can_DCM_DR_transmittingMsg = can_DCM_DR_txMsgStaticData;
