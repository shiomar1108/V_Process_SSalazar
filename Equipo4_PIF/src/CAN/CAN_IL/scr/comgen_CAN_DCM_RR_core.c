...
const CANrxMsgStaticData can_DCM_RR_rxMsgStaticData[kCAN_DCM_RR_nOfRxMsgs] = {\
		{kCAN_msgId_BCM_5,	kCAN_DCM_RR_msgTimeout_BCM_5,	&can_DCM_RR_BCM_5_rx_callback,	&can_DCM_RR_BCM_5_timeout_callback,	 \
				&can_DCM_RR_RxDataBuffer[0],	&can_DCM_RR_avlbl_buffer[kCAN_DCM_RR_avlbl_buffer_idx_BCM_5],	kCAN_DCM_RR_avlbl_slot_len_BCM_5,	 \
		...
		{kCAN_msgId_DCU_1,	kCAN_DCM_RR_msgTimeout_DCU_1,	&can_DCM_RR_DCU_1_rx_callback,	&can_DCM_RR_DCU_1_timeout_callback,	 \
				&can_DCM_RR_RxDataBuffer[8],	&can_DCM_RR_avlbl_buffer[kCAN_DCM_RR_avlbl_buffer_idx_DCU_1],	kCAN_DCM_RR_avlbl_slot_len_DCU_1,	 \
				&can_DCM_RR_rxMsgDynamicData[1],	{8u,	kFalse},	&can_DCM_RR_rxMsgStaticData[0],	NULL}, \
		{kCAN_msgId_DCU_2,	kCAN_DCM_RR_msgTimeout_DCU_2,	&can_DCM_RR_DCU_2_rx_callback,	&can_DCM_RR_DCU_2_timeout_callback,	 \
				&can_DCM_RR_RxDataBuffer[16],	&can_DCM_RR_avlbl_buffer[kCAN_DCM_RR_avlbl_buffer_idx_DCU_2],	kCAN_DCM_RR_avlbl_slot_len_DCU_2,	 \
				&can_DCM_RR_rxMsgDynamicData[2],	{8u,	kFalse},	&can_DCM_RR_rxMsgStaticData[1],	&can_DCM_RR_rxMsgStaticData[3]}, \
		{kCAN_msgId_BCM_2,	kCAN_DCM_RR_msgTimeout_BCM_2,	&can_DCM_RR_BCM_2_rx_callback,	&can_DCM_RR_BCM_2_timeout_callback,	 \
				&can_DCM_RR_RxDataBuffer[24],	&can_DCM_RR_avlbl_buffer[kCAN_DCM_RR_avlbl_buffer_idx_BCM_2],	kCAN_DCM_RR_avlbl_slot_len_BCM_2,	 \
				&can_DCM_RR_rxMsgDynamicData[3],	{8u,	kFalse},	NULL,	NULL}};

/* Rx search tree starting index */
#define kCAN_DCM_RR_RxSearchStartIdx		(2u)
...
//	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_WindowPos] 	= 0;
	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_reserved_0] 	= 0xFF;
//	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_WindowOp] 	= 0;
	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_reserved_1]	= 0xFF;
	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_DoorLockSts] = 2;
	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_reserved_2] 	= 0xFF;
//	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_MC] 			= 0;
//	can_DCM_RR_TxDataBuffer[BYTE_POS_DCU_4_CRC] 		= 0;
...
void can_DCM_RR_coreInit(void){
	...
	can_DCM_RR_transmittingMsg = can_DCM_RR_txMsgStaticData;
